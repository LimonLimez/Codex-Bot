...
part of the OpenBot distribution. CLIProxyAPI is licensed under the MIT
...
Legacy `codex-*`, `CODEX_BOT_*`, and `InstallCodexBot` identifiers remain only
as compatibility interfaces for the earlier macOS implementation.
