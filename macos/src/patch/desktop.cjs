...
function patchPreloadSource(source) {
  ...
  return replaceUnique(source, PRELOAD_ANCHOR, `${PRELOAD_PATCH}${STANDALONE_PRELOAD_PATCH}${LOCAL_FRAME_PRELOAD_PATCH}${PRELOAD_ANCHOR}`, "Grok Electron preload facade");
}
